...
| can_permissions | უფლებების მართვა |
...
### Permission assignment უსაფრთხოების პოლიტიკა

- მომხმარებელი ვერ ანიჭებს საკუთარ თავს ახალ უფლებებს (self-assignment აკრძალულია);
- მომხმარებელი ვერ ანიჭებს ისეთ უფლებას, რომელიც თვითონ არ აქვს;
- სისტემური/კრიტიკული permission-ების მინიჭება ხდება მხოლოდ `can_permissions` უფლებით;
- ოპერაცია ატომურია და დუბლიკატ მინიჭებაზე აბრუნებს `409 conflict`.
...
- Self-escalation ბლოკირება permission assignment-ზე.
...
# 13. არქიტექტურული გადაწყვეტილება

სისტემა იყენებს პირდაპირი უფლებების (Direct Permission Assignment) მოდელს, რადგან:

- მარტივია ადმინისტრირება;
- არ საჭიროებს Roles (RBAC);
- მოქნილია;
- ამცირებს სისტემის სირთულეს;
- მარტივად მასშტაბირდება მომავალში;
- საჭიროების შემთხვევაში მარტივად გადადის hybrid მოდელზე (Direct Permissions + Roles).
